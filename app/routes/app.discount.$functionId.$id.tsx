...
export const action = async ({ params, request }: ActionFunctionArgs) => {
  ...
  const parsedConfiguration = {
    ...
    applyToCheapestLineOnly: configuration.applyToCheapestLineOnly || false,
    minimumQuantity: parseFloat(configuration.minimumQuantity) || 0,
    quantityToDiscount: parseFloat(configuration.quantityToDiscount) || 0,
  };
  ...
  const initialData = {
    ...
    configuration: {
      ...
      applyToCheapestLineOnly:
        rawDiscount.configuration.applyToCheapestLineOnly || false,
      minimumQuantity: rawDiscount.configuration.minimumQuantity || 0,
      quantityToDiscount: rawDiscount.configuration.quantityToDiscount || 0,
    },
  };
